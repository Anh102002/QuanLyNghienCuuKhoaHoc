...
namespace QL_NCKH
{
    public partial class uc_hoithaoquocgia : DevExpress.XtraEditors.XtraUserControl
    {
        ...
        public void loadDLHT()
        {
            try
            {
                ...
                string query = " select MaHT,TenHoiThao,NgayToChuc,DiaDiem from HoiThao where CapHoiThao = N'Cấp Quốc Gia' ";
        ...
        private void uc_hoithaoquocgia_Load(object sender, EventArgs e)
        {
            loadDLHT();
            LoadProductListGV();
            LoadProductListKM();
            ...
            if (Ktra())
            {
                try
                {
                    if (KtraMaHT(txt_maht.Text))
                    {
                        ...
                        command.Parameters.AddWithValue("@Cap", "Cấp Quốc Gia");
            ...
            else
            {
                ...
                else
                {
                    ...
                    if (cbo_loai.SelectedIndex == 0)
                    {
                        try
                        {
                            string query = " select MaHT,TenHoiThao,NgayToChuc,DiaDiem from HoiThao where CapHoiThao = N'Cấp Quốc Gia' and MaHT like '%" + txt_timkiem.Text + "%' ";
                            DataTable dt = my.DocDL(query);
                            dgv_ht.DataSource = dt;
                            dgv_ht.Columns[0].HeaderText = "Mã hội thảo";
                            dgv_ht.Columns[1].HeaderText = "Tên hội thảo";
                    ...
                    else if (cbo_loai.SelectedIndex == 1)
                    {
                        try
                        {
                            ...
                            string query = " select MaHT,TenHoiThao,NgayToChuc,DiaDiem from HoiThao where CapHoiThao = N'Cấp Quốc Gia' and TenHoiThao like N'%" + txt_timkiem.Text + "%' ";
                            DataTable dt = my.DocDL(query);
                            dgv_ht.DataSource = dt;
                            dgv_ht.Columns[0].HeaderText = "Mã hội thảo";
                            dgv_ht.Columns[1].HeaderText = "Tên hội thảo";
        ...
        public void ExcelExportDSHT()
        {
            try
            {
                ...
                head.Value2 = "DANH SÁCH HỘI THẢO CẤP NHÀ NƯỚC";
        ...
        public void excelCTHT()
        {
            try
            {
                ...
                head.Value2 = "DANH SÁCH CHI TIẾT HỘI THẢO CẤP NHÀ NƯỚC  ";
        ...
        public DataTable LayDuLieuBaoCao1HT()
        {
            ...
            string query = " select MaHT,TenHoiThao,NgayToChuc,DiaDiem from HoiThao where CapHoiThao = N'Cấp Quốc Gia' and MaHT = '" + txt_maht.Text + "' ";
            DataTable dataTable = my.DocDL(query);
        ...
        {
            frm_bomaytochucHTQG frm = new frm_bomaytochucHTQG();

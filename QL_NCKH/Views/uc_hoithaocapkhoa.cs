...
namespace QL_NCKH
{
    public partial class uc_hoithaocapkhoa : DevExpress.XtraEditors.XtraUserControl
    {
        public uc_hoithaocapkhoa()
        {
            InitializeComponent();
        }
        ...
        public void loadDLHT()
        {
            try
            {
                ...
                string query = " select MaHT,TenHoiThao,NgayToChuc,DiaDiem from HoiThao where CapHoiThao = N'Cấp Khoa' ";
        ...
        private void uc_hoithaocapkhoa_Load(object sender, EventArgs e)
        {
            loadDLHT();
            LoadProductListGV();
            LoadProductListKM();
            ...
            if (Ktra())
            {
                try
                {
                    if (KtraMaHT(txt_maht.Text))
                    {
                        ...
                        command.Parameters.AddWithValue("@Cap", "Cấp Khoa");
            ...
            else
            {
                ...
                else
                {
                    ...
                    if (cbo_loai.SelectedIndex == 0)
                    {
                        try
                        {
                            string query = " select MaHT,TenHoiThao,NgayToChuc,DiaDiem from HoiThao where CapHoiThao = N'Cấp Khoa' and MaHT like '%" + txt_timkiem.Text + "%' ";
                            DataTable dt = my.DocDL(query);
                            dgv_ht.DataSource = dt;
                            dgv_ht.Columns[0].HeaderText = "Mã hội thảo";
                            dgv_ht.Columns[1].HeaderText = "Tên hội thảo";
                    ...
                    else if (cbo_loai.SelectedIndex == 1)
                    {
                        try
                        {
                            ...
                            string query = " select MaHT,TenHoiThao,NgayToChuc,DiaDiem from HoiThao where CapHoiThao = N'Cấp Khoa' and TenHoiThao like N'%" + txt_timkiem.Text + "%' ";
                            DataTable dt = my.DocDL(query);
                            dgv_ht.DataSource = dt;
                            dgv_ht.Columns[0].HeaderText = "Mã hội thảo";
                            dgv_ht.Columns[1].HeaderText = "Tên hội thảo";
        ...
        public void ExcelExportDSHT()
        {
            try
            {
                ...
                head.Value2 = "DANH SÁCH HỘI THẢO CẤP KHOA";
        ...
        public void excelCTHT()
        {
            try
            {
                ...
                head.Value2 = "DANH SÁCH CHI TIẾT HỘI THẢO CẤP KHOA  ";
                ...
                cl6.Value = "Ban tổ chức hội thảo";
        ...
        public DataTable LayDuLieuBaoCao1HT(string ma)
        {
            ...
            string query = " select MaHT,TenHoiThao,NgayToChuc,DiaDiem from HoiThao where CapHoiThao = N'Cấp Khoa' and MaHT = '" + ma + "' ";
            DataTable dataTable = my.DocDL(query);

...
namespace QL_NCKH
{
    public partial class uc_hoithaoquocte : DevExpress.XtraEditors.XtraUserControl
    {
        ...
        public void loadDLHT()
        {
            try
            {
                ...
                string query = " select MaHT,TenHoiThao,NgayToChuc,DiaDiem from HoiThao where CapHoiThao = N'Cấp Quốc Tế' ";
        ...
        private void uc_hoithaoquocte_Load(object sender, EventArgs e)
        {
            loadDLHT();
            LoadProductListGV();
            LoadProductListKM();
            ...
            if (Ktra())
            {
                try
                {
                    if(KtraMaHT(txt_maht.Text))
                    {
                        ...
                        command.Parameters.AddWithValue("@Cap", "Cấp Quốc Tế");
        ...
        private void txt_timkiem_ButtonClick(object sender, DevExpress.XtraEditors.Controls.ButtonPressedEventArgs e)
        {
            ...
            else
            {
                ...
                else
                {
                    ...
                    if (cbo_loai.SelectedIndex == 0)
                    {
                        try
                        {
                            string query = " select MaHT,TenHoiThao,NgayToChuc,DiaDiem from HoiThao where CapHoiThao = N'Cấp Quốc Tế' and MaHT like '%"+txt_timkiem.Text+"%' ";
                            DataTable dt = my.DocDL(query);
                            dgv_ht.DataSource = dt;
                            dgv_ht.Columns[0].HeaderText = "Mã hội thảo";
                            dgv_ht.Columns[1].HeaderText = "Tên hội thảo";
                    ...
                    else if (cbo_loai.SelectedIndex == 1)
                    {
                        try
                        {
                            ...
                            string query = " select MaHT,TenHoiThao,NgayToChuc,DiaDiem from HoiThao where CapHoiThao = N'Cấp Quốc Tế' and TenHoiThao like N'%" + txt_timkiem.Text + "%' ";
                            DataTable dt = my.DocDL(query);
                            dgv_ht.DataSource = dt;
                            dgv_ht.Columns[0].HeaderText = "Mã hội thảo";
                            dgv_ht.Columns[1].HeaderText = "Tên hội thảo";
        ...
        public void ExcelExportDSHT()
        {
            try
            {
                ...
                head.Value2 = "DANH SÁCH HỘI THẢO QUỐC TẾ";
        ...
        public void excelCTHT()
        {
            try
            {
                ...
                head.Value2 = "DANH SÁCH CHI TIẾT HỘI THẢO QUỐC TẾ  ";
        ...
        public DataTable LayDuLieuBaoCao1HT()
        {
            ...
            string query = " select MaHT,TenHoiThao,NgayToChuc,DiaDiem from HoiThao where CapHoiThao = N'Cấp Quốc Tế' and MaHT = '"+txt_maht.Text+"' ";
            DataTable dataTable = my.DocDL(query);
        ...
        {
            frm_bomaytochucHTQT frm = new frm_bomaytochucHTQT();
        ...
        private void ShowSuggestionsDD(List<string> suggestions)
        {
           
        }

        private void list_dongtochuc_SelectedIndexChanged(object sender, EventArgs e)
        {
        ...
        private void btn_themdongtc_Click_1(object sender, EventArgs e)
        {
        ...
        private void btn_loaidtc_Click_1(object sender, EventArgs e)
        {
            if (string.IsNullOrWhiteSpace(txt_madd.Text) || string.IsNullOrWhiteSpace(txt_tendd.Text) || string.IsNullOrWhiteSpace(txt_chucvudd.Text))
            {
                MessageBox.Show("Vui lòng nhập đầy đủ thông tin !", "Thông báo");
        ...
        private void dgv_dd_CellClick_1(object sender, DataGridViewCellEventArgs e)
        {
            try
            {

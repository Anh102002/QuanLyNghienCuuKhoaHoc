...
namespace QL_NCKH
{
    public partial class uc_detaiNCKHsv : DevExpress.XtraEditors.XtraUserControl
    {
        MyClass my = new MyClass();
        private List<string> productList;
        private List<string> productListSV;
        private string madt;
        public uc_detaiNCKHsv()
        {
            InitializeComponent();
        }
        public string Madt
        ...
        public void LoadDL()
        {
            ...
            string query = @"select 
                                    DeTai.MaDeTai,DeTai.TenDeTai,DeTai.Khoa,DeTai.LinhVuc,TienDoDeTai.NgayBatDau,TienDoDeTai.NgayKetThuc,TienDoDeTai.TienDo
                                from DeTai,TienDoDeTai  
                                    where CapDeTai = N'" + cap + "' and TienDoDeTai.MaDeTai = DeTai.MaDeTai and DeTai.DoiTuong = N'Sinh viên'";
        ...
        public void LoadDLSV(string ma)
        {
            string query = "  SELECT ChiTietSVDeTai.MaSV, SinhVien.HoTen, ChiTietSVDeTai.ChucVu FROM ChiTietSVDeTai, SinhVien WHERE ChiTietSVDeTai.MaSV = SinhVien.MaSV AND MaDeTai = '"+ma+"'  ";
            DataTable dt = my.DocDL(query);
        ...
        private void uc_detaiNCKHsv_Load(object sender, EventArgs e)
        {
            try
            {
                LoadDL();
        ...
        public void MaSV()
        {
            try
            {
                ...
                if (tb.Rows.Count > 0)
                {
                    ...
                    {
                        string ma = tb.Rows[i]["MaSV"].ToString();
                        cbo_sv.Items.Add(ma);
                    }
                }
            }
            ...
            {
                MessageBox.Show("lỗi lấy dữ liệu mã sinh viên !", "Thông báo");
            }
        }
        public void MaHD()
        {
            ...
            if (Ktra())
            {
                if (KtraMaDT(txt_madt.Text))
                {
                    try
                    {
                        ...
                        string cap = "Cấp Cơ Sở";                       
                        string sql = "insert into DeTai values('" + txt_madt.Text + "',N'" + txt_tendt.Text + "',N'" + cb_khoa.Text + "',N'" + txt_linhvuc.Text + "',N'" + cap + "',N'Sinh viên')";
            ...
            if (Ktra())
            {
                if (!KtraMaDT(txt_madt.Text))
                {
                    try
                    {
                        ...
                        string date1 = dtp_ngaybd.Value.ToString("yyyy/MM/dd");
                        string date2 = dtp_ngaykt.Value.ToString("yyyy/MM/dd");
                        string sql = "update DeTai set TenDeTai = N'" + txt_tendt.Text + "',Khoa = N'" + cb_khoa.Text + "',LinhVuc=N'" + txt_linhvuc.Text + "',Capdetai = N'" + cap + "',DoiTuong = N'Sinh viên' where MaDeTai = '" + txt_madt.Text + "' ";
                        int up = my.Update(sql);
                        if (up > 0)
                        {
                ...
                if (!KtraMaDT(txt_madt.Text))
                {
                    try
                    {
                        ...
                        if (tb == DialogResult.OK)
                        {
                            ...
                            int up3 = my.Update("delete from ChiTietSVDeTai where MaDeTai = '" + ma + "' ");
                            int up8 = my.Update("delete from ChiTietGVDeTai where MaDeTai = '" + ma + "' ");
                            ...
                            if (up2 >= 0)
                            {
                                if (up3 >= 0)
                                {
                                    ...
                                    {
                                        MessageBox.Show("Xóa thông tin không thành công {8} ", "Thông báo");
                    ...
                    if (cbo_tk.Text == "Mã Đề Tài")
                    {
                        try
                        {
                            string sql = @"SELECT DeTai.MaDeTai, DeTai.TenDeTai, DeTai.Khoa, DeTai.LinhVuc, TienDoDeTai.NgayBatDau, TienDoDeTai.NgayKetThuc, TienDoDeTai.TienDo
                                            ...
                                            WHERE DeTai.CapDeTai = N'" + cap + "' AND DeTai.MaDeTai LIKE '%" + txt_timkiem.Text + "%' AND DeTai.DoiTuong = N'Sinh viên' ";
                    ...
                    else if (cbo_tk.Text == "Tên Đề Tài")
                    {
                        try
                        {
                            ...
                            string sql = @"SELECT DeTai.MaDeTai, DeTai.TenDeTai, DeTai.Khoa, DeTai.LinhVuc, TienDoDeTai.NgayBatDau, TienDoDeTai.NgayKetThuc, TienDoDeTai.TienDo
                                            FROM DeTai
                                            JOIN TienDoDeTai ON TienDoDeTai.MaDeTai = DeTai.MaDeTai
                                            WHERE DeTai.CapDeTai = N'" + cap + "' AND DeTai.TenDeTai LIKE N'%" + txt_timkiem.Text + "%' AND DeTai.DoiTuong = N'Sinh viên' ";
                    ...
                    else
                    {
                        try
                        {
                            ...
                            string sql = @"SELECT DeTai.MaDeTai, DeTai.TenDeTai, DeTai.Khoa, DeTai.LinhVuc, TienDoDeTai.NgayBatDau, TienDoDeTai.NgayKetThuc, TienDoDeTai.TienDo
                                            FROM DeTai
                                            JOIN TienDoDeTai ON TienDoDeTai.MaDeTai = DeTai.MaDeTai
                                            WHERE DeTai.CapDeTai = N'" + cap + "' AND DeTai.Khoa LIKE N'%" + txt_timkiem.Text + "%'  AND DeTai.DoiTuong = N'Sinh viên' ";
        ...
        private void dgv_sv_CellContentClick(object sender, DataGridViewCellEventArgs e)
        {
            try
            {
                cbo_sv.Text = dgv_sv.CurrentRow.Cells[0].Value.ToString();
            ...
            {
                MessageBox.Show("lỗi hiển thị dữ liệu sinh viên!", "Thông báo");
            }
        }

        private void cbo_sv_SelectedIndexChanged(object sender, EventArgs e)
        {
            try
            {
                if (cbo_sv.SelectedIndex != -1)
                {
                    string ma = cbo_sv.SelectedItem.ToString();
            ...
            {
                MessageBox.Show("lỗi hiển thị tên sinh viên!", "Thông báo");
            }
        }

        public bool KtraMaSVDT(string magv, string madt)
        {
            try
            {
                string sql = "select * from ChiTietSVDeTai where MaSV = '" + magv + "' and MaDeTai = '" + madt + "' ";
                DataTable tb = my.DocDL(sql);
                if (tb.Rows.Count > 0)
                {
                    return false;
            ...
            {
                MessageBox.Show("Lỗi kiểm tra mã sinh viên !", "Thông báo");
            }
            return true;
        }
        ...
        private void btn_joinsv_Click(object sender, EventArgs e)
        {

            if (string.IsNullOrWhiteSpace(cbo_sv.Text) || string.IsNullOrWhiteSpace(txt_tensv.Text) || string.IsNullOrWhiteSpace(cbo_chucvusv.Text))
            {
            ...
            else
            {
                try
                {
                    ...
                    {
                        string madt = Madt;
                        if (KtraMaSVDT(cbo_sv.Text, madt))
                        {

                            
                                string sql = "insert into ChiTietSVDeTai values ('" + cbo_sv.Text + "','" + madt + "',N'" + cbo_chucvusv.Text + "')";
                                int up = my.Update(sql);
                                if (up > 0)
                                {
                        ...
                        {
                            MessageBox.Show("Sinh viên đã tham gia đề tài !", "Thông báo");
                        }
                    }
        ...
        private void btn_cancelsv_Click(object sender, EventArgs e)
        {
            if (string.IsNullOrWhiteSpace(cbo_sv.Text) || string.IsNullOrWhiteSpace(txt_tensv.Text) || string.IsNullOrWhiteSpace(cbo_chucvusv.Text))
            {
                MessageBox.Show("Vui lòng chọn đầy đủ thông tin !", "Thông báo");
            ...
            else
            {
                ...
                else
                {
                    ...
                    {
                        string madt = Madt;
                        string sql = "delete from ChiTietSVDeTai where MaSV='" + cbo_sv.Text + "' and MaDeTai = '" + madt + "' ";
                        int up =my.Update(sql);
                       if(up > 0)
                        {
        ...
        public void ExcelExport()
        {
            try
            {
                ...
                head.Value2 = "DANH SÁCH ĐỀ TÀI NGHIÊN CỨU KHOA HỌC CỦA SINH VIÊN";
        ...
        private void btn_suasv_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                else
                {
                    ...
                    {
                        string madt = Madt;
                        string sql = "update ChiTietSVDeTai set ChucVu = N'" + cbo_chucvusv.Text + "' where MaSV='" + cbo_sv.Text + "' and MaDeTai = '" + madt + "' ";
                         int up = my.Update(sql);
                        if(up>0)
                        {
        ...
        private void LoadProductListSV()
        {
            try
            {
        ...
        private void ShowSuggestionsSV(List<string> suggestions)
        {
            list_sv.Items.Clear();
        ...
        private void cbo_sv_TextChanged(object sender, EventArgs e)
        {
            if (dgv_sv.Rows.Count >= 0)
            {
                string searchTerm = cbo_sv.Text.ToLower();
                if (!string.IsNullOrWhiteSpace(searchTerm))
                {
                   ...
                   .ToList();
                    ...
                    ShowSuggestionsSV(filteredProducts);
                }
                else
                {
        ...
        public void excelCT()
        {
            try
            {
                ...
                head.Value2 = "DANH SÁCH CHI TIẾT ĐỀ TÀI NGHIÊN CỨU KHOA HỌC CỦA SINH VIÊN ";
                ...
                cl8.Value = "Thành viên hướng dẫn - Chức vụ";

                Excel.Range cl9 = oSheet.get_Range("J3", "J3");
                cl9.Value = "Thành viên hội đồng - Chức vụ";
                ...
                for (int i = 0; i < dataTable.Rows.Count; i++)
                {
                    ...
                    //
                    string sv = "SELECT SinhVien.HoTen, ChiTietSVDeTai.ChucVu FROM ChiTietSVDeTai, SinhVien WHERE ChiTietSVDeTai.MaSV = SinhVien.MaSV AND MaDeTai = '" + ma + "' ";

                    DataTable dtsv = my.DocDL(sv);

                    Excel.Range line3 = oSheet.get_Range("H" + (lines).ToString(), "H" + (lines).ToString());

                    for (int row = 0; row < dtsv.Rows.Count; row++)
                    {

                        string cel = dtsv.Rows[row]["HoTen"].ToString() + "-" + dtsv.Rows[row]["ChucVu"].ToString() + "\n";
                        line3.Value += cel;
                    ...
                    Excel.Range line2 = oSheet.get_Range("J" + (lines).ToString(), "J" + (lines).ToString());
        ...
        public DataTable LayDuLieuBaoCao()
        {
            ...
            WHERE DeTai.Capdetai = N'Cấp Cơ Sở' and DeTai.DoiTuong = N'Sinh viên'
           ";
        ...
        private void btn_joingv_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                try
                {
                    ...
                    {
                        string madt = Madt;
                        if (KtraMaGVDT(txt_magv.Text, madt))
                        {

                            if (KtraHD(txt_magv.Text))
                            {
                                string sql = "insert into ChiTietGVDeTai values ('" + txt_magv.Text + "','" + madt + "',N'" + cbo_chucvugv.Text + "')";
                                int up = my.Update(sql);
                                if (up > 0)
                                {
                                    MessageBox.Show("Tham gia đề tài thành công !", "Thông báo");
        ...
        private void btn_cancelgv_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                else
                {
                    ...
                    {
                        string madt = Madt;
                        string sql = "delete from ChiTietGVDeTai where MaGV='" + txt_magv.Text + "' and MaDeTai = '" + madt + "' ";
                        int up = my.Update(sql);
                        if (up > 0)
                        {
                            MessageBox.Show("Loại bỏ thành viên thành công !", "Thông báo");
        ...
        public void excelCT1DT()
        {
            try
            {
                if(Ktra())
                {
                    ...
                    head.Value2 = "THÔNG TIN ĐỀ TÀI NGHIÊN CỨU KHOA HỌC CỦA SINH VIÊN ";
        ...
        public DataTable LayDuLieuBaoCao1DT()
        {
            ...
            LEFT JOIN
                TienDoDeTai ON DeTai.MaDeTai = TienDoDeTai.MaDeTai            
            WHERE DeTai.Capdetai = N'Cấp Cơ Sở' and DeTai.DoiTuong = N'Sinh viên' and MaDeTai = '"+txt_madt.Text+"' ";
            DataTable dataTable = my.DocDL(sql);

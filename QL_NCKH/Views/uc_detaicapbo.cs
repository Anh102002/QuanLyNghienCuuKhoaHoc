...
namespace QL_NCKH
{
    public partial class uc_detaicapbo : DevExpress.XtraEditors.XtraUserControl
    {
        MyClass my = new MyClass();
        private List<string> productList;
        private List<string> productListHDNT;
        private string madt;
        public uc_detaicapbo()
        {
            InitializeComponent();
        }
        public string Madt
        ...
        private void uc_detaicapbo_Load(object sender, EventArgs e)
        { 
            try
            {
                LoadDL();
            ...
            {
                MessageBox.Show("$ Lỗi hiển thị thông tin đề tài cấp bộ !","Lỗi");
            }
        }
        ...
        public void ExcelExport()
        {
            try
            {
                ...
                head.Value2 = "DANH SÁCH ĐỀ TÀI NGHIÊN CỨU KHOA HỌC CẤP BỘ";
        ...
        public DataTable LayDuLieuBaoCao()
        {
            ...
            WHERE DeTai.Capdetai = N'Cấp Bộ' and DeTai.DoiTuong = N'Giảng viên'
           ";
        ...
        public void excelCT()
        {
            try
            {
                ...
                head.Value2 = "DANH SÁCH CHI TIẾT ĐỀ TÀI NGHIÊN CỨU KHOA HỌC CẤP BỘ  ";
        ...
        private void btn_joingv_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                try
                {
                    if (string.IsNullOrWhiteSpace(Madt) || !Ktra())
                    {
        ...
        private void btn_cancelgv_Click(object sender, EventArgs e)
        {
            ...
            {
                if (dgv_gv.DataSource == null || !Ktra())
                {
        ...
        private void btn_joinhd_Click(object sender, EventArgs e)
        {
            ...
            {
                if (dgv_hd.DataSource == null || !Ktra())
                {
                    MessageBox.Show("Vui lòng chọn đề tài muốn tham gia !", "Thông báo");
                }
                else
        ...
        private void btn_joinhdnt_Click(object sender, EventArgs e)
        {
            ...
            {
                if (dgv_hdnt.DataSource == null || !Ktra())
                {
                    MessageBox.Show("Vui lòng chọn đề tài muốn tham gia !", "Thông báo");
                }
                else
        ...
        private void list_gv_SelectedIndexChanged_1(object sender, EventArgs e)
        {
        ...
        public DataTable LayDuLieuBaoCao1DT()
        {
            ...
            LEFT JOIN
                TienDoDeTai ON DeTai.MaDeTai = TienDoDeTai.MaDeTai            
            WHERE DeTai.Capdetai = N'Cấp Bộ' and DeTai.DoiTuong = N'Giảng viên' and DeTai.MaDeTai = '"+txt_madt.Text+"' ";
            DataTable dataTable = my.DocDL(sql);
        ...
        public void excelCT1DT()
        {
            try
            {
                if(Ktra())
                {
                    ...
                    head.Value2 = "THÔNG TIN ĐỀ TÀI NGHIÊN CỨU KHOA HỌC CẤP BỘ  ";
        ...
        private void dgv_hd_CellBorderStyleChanged(object sender, EventArgs e)
        {
